...
```{r loadData}
library(rGWIPS)
loadGWIPSdata(forward = "../extdata/Liu13_All.RiboProElongFor.bw", reverse = "../extdata/Liu13_All.RiboProElongRev.bw")
...
features <- import.gff3( "../extdata/Escherichia_coli_str_k_12_substr_mg1655.ASM584v2.32.gff3.txt")
summary(features)
```
...
library(ggplot2)
ggplot(aq, aes(x=variable, y=mean(as.numeric(value)), group=variable)) + geom_point()
```
